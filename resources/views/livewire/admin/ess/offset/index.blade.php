        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 text-uppercase fw-bold" id="staticBackdropLabel">View Offset Application</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="alert alert-info mb-3">
                        <small><strong>Note:</strong> Offset allows employees to work on non-working days (e.g., weekends) to compensate for past absences or future planned time off.</small>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <label class="mb-2" for="supervisor">Supervisor</label>
                            <input type="text" id="supervisor" class="form-control restricted" value="{{ $view_records->supervisor_name ?? 'N/A' }}" readonly>
                        </div>
                        <div class="col-12 col-md-6 mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-4">
                            <label class="mb-2" for="offset_date_from">Offset Date</label>
                            <input type="date" id="offset_date_from" class="form-control restricted" value="{{ isset($view_records) ? $view_records->offset_date_from : '' }}" readonly>
                        </div>
                        <div class="col-12 col-md-6 mb-4">
                            <label class="mb-2" for="offset_date_to">Activity Date</label>
                            <input type="date" id="offset_date_to" class="form-control restricted" value="{{ isset($view_records) ? $view_records->offset_date_to : '' }}" readonly>
                        </div>
                        <div class="col-12 col-md-12 mb-4">
