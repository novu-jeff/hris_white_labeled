                ...
                <table class="table table-bordered mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" style="width: 300px" wire:model="records.{{$key}}.from_year" id="records.{{$key}}.from_year" class="form-control text-uppercase text-center" placeholder="e.g. 2010">
                                <div class="error-field">
                                    @error('records.'.$key.'.from_year') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </td>
                            <td>
                                <input type="text" style="width: 300px" wire:model="records.{{$key}}.to_year" id="records.{{$key}}.to_year" class="form-control text-uppercase text-center" placeholder="e.g. 2014">
                                <div class="error-field">
                            ...
                            <td>
                                <input type="text" style="width: 300px" wire:model="records.{{$key}}.year_graduated" id="records.{{$key}}.year_graduated" class="form-control text-uppercase text-center" placeholder="e.g. 2014">
                                <div class="error-field">
