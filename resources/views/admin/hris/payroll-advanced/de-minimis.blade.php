@extends('layouts.admin', [
    'title' => 'HRIS | De Minimis Sub Items'
])
...
<div class="main-content flex-grow-1 p-4">
    <div class="container pb-5">
        ...
        <div class="alert alert-info border-0">
            Use this section to manage de minimis-type earnings (e.g., rice, laundry, medical cash, uniform) and assign amounts per employee.
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent border-0">
                <h5 class="mb-0 text-uppercase fw-bold">Configured De Minimis Items</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @forelse($deMinimisItems as $item)
                                <tr>
                                    <td>{{ $item->code }}</td>
                                    <td>{{ $item->name }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted">No de minimis item found yet. Create one in Earnings Settings.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
