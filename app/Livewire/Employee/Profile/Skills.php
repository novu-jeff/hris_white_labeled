...
class Skills extends Component
{
    ...
    public function removeRecord(bool $isNotify, $index = null) {
        ...
        $storedRecords = EmployeeSkillsHobbies::where('employee_no', $this->employee_no)
            ->orderBy('created_at', 'asc')
            ->get();
    ...
    public function download(int $index) {
        ...
        $files = EmployeeUpdateSkillsHobbies::where('employee_no', $this->employee_no)
            ->orderBy('created_at', 'asc')
            ->pluck('documents');

        $files = $files->isNotEmpty()
            ? $files
            : EmployeeSkillsHobbies::where('employee_no', $this->employee_no)
                ->orderBy('created_at', 'asc')
                ->pluck('documents');
    ...
    {
        return view('livewire.employee.profile.skills');
    }
}
